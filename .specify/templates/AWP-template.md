...
<!-- 【新增章节 - 来自 spec-kit 原始 tasks-template.md】 -->
<!-- 【目的】: 提供"一眼看懂"的任务依赖关系图 -->
...
<!-- 【新增章节 - 来自 spec-kit 原始 checklist-template.md】 -->
<!-- 【目的】: 将"需求质量检查"整合到 AWP 工作流中 -->
<!-- 【核心理念】: Checklist 是"需求文档的单元测试" -->
